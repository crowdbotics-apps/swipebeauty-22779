"""swipebeauty_22779 URL Configuration
...
admin.site.site_header = "Swipebeauty"
admin.site.site_title = "Swipebeauty Admin Portal"
admin.site.index_title = "Swipebeauty Admin"

# swagger
api_info = openapi.Info(
    title="Swipebeauty API",
    default_version="v1",
    description="API documentation for Swipebeauty App",
)
